/*
<javascriptresource>
<name>ExportWebImage_ver1.2</name>
<menu>automate</menu>
...
//ダイアログボックスを作成------------------------------------------//
	//キャンバスサイズ、ドキュメントの長辺を取得を呼び出し
	docInfo();
	//ダイアログボックスを作成
	 saveGUI = new Window("dialog","ExportWebImage_ver1.2", [0,100,402,100+226]);
	//中央に配置
	saveGUI.center(); 
	//長辺のテキストボックス
	...
	saveGUI.sText = saveGUI.add("statictext",[86,98,86+42,108+20], "単位:");
	//書き出すファイルの種類の指定
	...
	//OKボタンの作成
	saveGUI.okBtn = saveGUI.add("button",[242-10,170,242+110,170+35],"いいと思います",{name:"ok"}); 
	//キャンセルボタン
	saveGUI.cancelBtn = saveGUI.add("button",[61-10,170,61+110,170+35], "ダメですね", {name: "cancel"});
	//パネルの作成
...
//キャンセル処理
	saveGUI.cancelBtn.onClick = function(){
		saveGUI.close();
		}
//ダイアログボックスを表示する
	saveGUI.show();
